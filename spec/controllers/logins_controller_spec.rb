  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved login as @login" do
        ...
        post :create, {:login => { "email" => "invalid value" }}, valid_session
        assigns(:login).should be_a_new(Login)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested login" do
        ...
        Login.any_instance.should_receive(:update_attributes).with({ "email" => "MyString" })
        put :update, {:id => login.to_param, :login => { "email" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the login as @login" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Login.any_instance.stub(:save).and_return(false)
        put :update, {:id => login.to_param, :login => { "email" => "invalid value" }}, valid_session
        assigns(:login).should eq(login)
      end
