...
describe CommentsController do
  ...
  before do
    @comment = Comment.create(:name => "thiyagu", :description => 'good', :user_id => 1, :episode_id => 1) 
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created comment" do
        post :create, {:comment => valid_attributes}, valid_session
        response.should redirect_to("/episodes/#tabs1-comment")
      end
    end

    describe "with invalid paramsr" do
